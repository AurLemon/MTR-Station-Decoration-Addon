...
public class MSDMainClient {
    public static void init() {
        ...
        RegistryClient.registerTileEntityRenderer(MSDBlockEntityTypes.STANDING_SIGN_TILE_ENTITY.get(), dispatcher -> new RenderCustomTextSign<>(dispatcher, 3, 8F, 14.5F, 7.01F, 15F, 14, true, 0x000000, true, 0xFFFFFF, 2.5F, 3.5F, 7.0F, 0.0625F));
        RegistryClient.registerTileEntityRenderer(MSDBlockEntityTypes.STANDING_SIGN_1_TILE_ENTITY.get(), dispatcher -> new RenderCustomTextSign<>(dispatcher, 1, 2.5F, 9.25F, 7.65F, 4F, 16, true, 0xFFFFFF, false, 0xFFFFFF, 3.2F, 3.2F, 6.4F, 0.0625F));
